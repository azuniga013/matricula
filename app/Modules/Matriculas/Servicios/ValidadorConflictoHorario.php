...
final class ValidadorConflictoHorario
{
    public function validar(int $estudianteId, int $ofertaAcademicaId, ?int $excluirMatriculaId = null): ?string
    {
    ...
    {
        if ($a->es_24_horas || $b->es_24_horas) {
            return true;
        }
