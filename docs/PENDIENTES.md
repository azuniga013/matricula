...
| `P-014` | `completado` | Mostrar cuentas bancarias de depósito en el Dashboard del Estudiante. | El Dashboard recibe las cuentas activas en la respuesta principal del portal, lista banco, nombre, número y tipo, y muestra una alerta visible si no hay cuentas configuradas. |
