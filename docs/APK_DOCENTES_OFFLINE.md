...
El archivo firmado se conserva en `storage/app/private/apk-docentes/` (raíz
del disco `Storage::disk('local')` en Laravel 12), fuera de la raíz pública. No se debe copiar manualmente a `public/` ni enviar enlaces a
