            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between mb-4">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">Realice su gestión desde el banco de su preferencia y luego registre el pago con su comprobante.</p>
                        </div>
                    ...
                    <template x-if="cuentasBancarias.length > 0"><div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <template x-for="cuenta in cuentasBancarias" :key="cuenta.id">
                            <div class="rounded-lg border border-brand-100 bg-brand-50/40 p-4">
                                ...
                                <p class="mt-2 text-sm text-gray-500" x-text="cuenta.nombre"></p>
                                <p class="mt-1 font-mono text-lg font-semibold text-gray-900" x-text="cuenta.numero_cuenta"></p>
            ...
            <template x-if="portal?.whatsapp">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-semibold text-gray-900" x-text="'Horario WhatsApp: ' + (portal.whatsapp.grupo || '')"></p>
                        ...
                        <a x-show="portal.whatsapp.link" :href="portal.whatsapp.link" target="_blank" class="ml-auto inline-flex items-center gap-1 bg-green-500 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-green-600 transition-colors">Unirme al horario</a>
...
function dashboard() {
    return { loading: true, portal: null, cuentasBancarias: [], async loadData() {
