                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-7 gap-4">
                            ...
                            <div><label class="label">Horario</label><select x-model="filtroRecibos.oferta" @change="loadRecibos()" class="input" :disabled="!filtroRecibos.nivel"><option value="">Todos</option><template x-for="o in ofertasRecibosNivel" :key="o.id"><option :value="o.id" x-text="o.codigo + ' · ' + (o.horario?.nombre || '')"></option></template></select></div>
