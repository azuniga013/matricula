    ...
    return {
        ...
        catalogo: {
            ...
            financieros: [
                ...
                { id: 'pendientes-por-estudiante', label: 'Cuentas Pendientes por Estudiante', url: '/api/v1/reportes/financieros/pendientes-por-estudiante', fechaDesde: false, fechaHasta: false, sucursal: true, periodo: true,
